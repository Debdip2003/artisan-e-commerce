    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Absolutely love the fabric and detailing. Feels unique and special.",
      },
      {
        name: "Neha S.",
        rating: 4,
        comment: "Soft and comfy, and the craftsmanship is impressive.",
      },
    ],
  },
  Jewelry: {
    ...
    reviews: [
      {
        name: "Varun G.",
        rating: 5,
        comment: "Gorgeous and earthy decor. It’s an aesthetic delight.",
      },
      {
        name: "Priya D.",
        rating: 4,
        comment: "Loved the handmade vibe. Makes my living room pop!",
      },
    ],
  },
  Pottery: {
    ...
    reviews: [
      {
        name: "Soham T.",
        rating: 5,
        comment: "Perfect glaze and shape. Looks lovely on my dining table.",
      },
      {
        name: "Isha J.",
        rating: 4,
        comment: "Delicate and elegant, great for gifting too!",
      },
    ],
  },
  Handwoven: {
...
const artisanDetails = {
  artisan1: {
    ...
    region: "Rajasthan",
    description:
      "Suman specializes in traditional block printing using natural dyes. Her work reflects the vibrant culture of rural Rajasthan.",
  },
  artisan2: {
    name: "Rahul Meena",
    region: "Madhya Pradesh",
    description:
      "Rahul handcrafts terracotta pottery, shaping each piece with precision inspired by local folklore.",
  },
  artisan3: {
    name: "Ayesha Khan",
    region: "Uttar Pradesh",
    description:
      "Ayesha’s embroidery blends Mughal floral motifs with modern design, rooted in generations of artistry.",
  },
  artisan4: {
    name: "Tashi Norbu",
    region: "Ladakh",
    description:
      "Tashi works with wool to create traditional handwoven pieces that capture the spirit of the Himalayas.",
  },
  artisan5: {
    name: "Kamala Bai",
    region: "Andhra Pradesh",
    description:
      "Kamala weaves intricate bamboo crafts, turning sustainable materials into elegant home decor.",
  },
  artisan6: {
    name: "Devendra Das",
    region: "Odisha",
    description:
      "Devendra is known for his stone carving skills, turning raw granite into sculptures inspired by temple art.",
  },
  artisan7: {
    name: "Fatima Begum",
    region: "Kashmir",
    description:
      "Fatima embroiders shawls with delicate needlework, preserving the legacy of Kashmiri craft.",
  },
  artisan8: {
    name: "Manoj Kumar",
    region: "Himachal Pradesh",
    description:
      "Manoj carves intricate wooden patterns using techniques passed through his family for decades.",
  },
  artisan9: {
    name: "Lalita Joshi",
    region: "Gujarat",
    description:
      "Lalita uses mirror and beadwork to bring vibrant patterns to life, celebrating Gujarati traditions.",
  },
  artisan10: {
    name: "Anil Thapa",
    region: "Sikkim",
    description:
      "Anil crafts eco-friendly bamboo lamps and baskets, deeply inspired by mountain life.",
  },
  artisan11: {
    name: "Pooja Rani",
    region: "Punjab",
    description:
      "Pooja blends bold colors and fine threadwork in her embroidery, capturing Punjabi festivity.",
  },
  artisan12: {
    name: "Naveen Patil",
    region: "Karnataka",
    description:
      "Naveen specializes in block printing with traditional plant-based inks and hand-carved wood stamps.",
  },
  artisan13: {
    name: "Rekha Sharma",
    region: "Delhi",
    description:
      "Rekha blends contemporary jewelry styles with Mughal techniques, creating timeless statement pieces.",
  },
  artisan14: {
    name: "Bhavesh Patel",
    region: "Maharashtra",
    description:
      "Bhavesh carves unique wooden toys and homeware with a sustainable approach and playful flair.",
  },
  artisan15: {
    name: "Sarita Kumari",
    region: "Bihar",
    description:
      "Sarita creates Madhubani-inspired patterns on textiles using brushes and natural colors.",
  },
  artisan16: {
    name: "Kiran Verma",
    region: "Chhattisgarh",
    description:
      "Kiran molds earthy terracotta sculptures, celebrating tribal traditions in a modern format.",
  },
  artisan17: {
    name: "Ranjit Singh",
    region: "Haryana",
    description:
      "Ranjit weaves traditional cotton dhurries with minimal tools but maximum skill.",
  },
  artisan18: {
    name: "Lobsang Dolma",
    region: "Arunachal Pradesh",
    description:
      "Lobsang makes intricate beadwork jewelry inspired by the spiritual colors of her region.",
  },
  artisan19: {
    name: "Meena Bai",
    region: "Madhya Pradesh",
    description:
      "Meena creates natural-dyed handloom textiles using ancient looms.",
  },
  artisan20: {
    name: "Sameer Sheikh",
    region: "West Bengal",
    description:
      "Sameer blends jute and cotton to make contemporary textile decor with a rustic feel.",
  },
  artisan21: {
    name: "Deepa Naik",
    region: "Goa",
    description:
      "Deepa’s jewelry draws on seashells and local elements to create vibrant, coastal charm pieces.",
  },
  artisan22: {
    name: "Girish Raut",
    region: "Maharashtra",
    description:
      "Girish’s woodwork fuses functionality with cultural motifs inspired by Wari traditions.",
  },
  artisan23: {
    name: "Ravina Chauhan",
    region: "Rajasthan",
    description:
      "Ravina paints clay pottery with traditional patterns in vibrant natural colors.",
  },
  artisan24: {
    name: "Imran Qureshi",
    region: "Uttar Pradesh",
    description:
      "Imran’s embroidery reflects Indo-Islamic design, combining color, form, and intricate detail.",
  },
};
