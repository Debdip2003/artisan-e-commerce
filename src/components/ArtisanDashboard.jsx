...
const ArtisanDashboard = () => {
  ...
  const [products, setProducts] = useState([
    { 
      ...
      sold: true, 
      stock: 0,
      description: 'Pure silk handwoven shawl with traditional motifs. Perfect for special occasions.',
    ...
    { 
      ...
      sold: false, 
      stock: 5,
      description: 'Handcrafted ceramic tea set with 6 cups and a teapot. Microwave safe.',
    ...
    { 
      ...
      sold: false, 
      stock: 2,
      description: 'Carved from sustainable sheesham wood. Approximately 8 inches tall.',
    ...
    { 
      ...
      sold: true, 
      stock: 0,
      description: 'Hand block printed cotton saree with organic dyes. Breathable and comfortable.',
    ...
    { 
      ...
      sold: false, 
      stock: 3,
      description: 'Traditional brass pooja thali with intricate engravings. Comes with diyas.',
  ...
  const handleAddProduct = (e) => {
    ...
    const productToAdd = {
      ...
      image: newProduct.image ? URL.createObjectURL(newProduct.image) : '/images/default-product.jpg'
    };
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-semibold">
                    ₹{products.filter(p => p.sold).reduce((sum, product) => sum + product.price, 0)}
                  </p>
                </div>
              </div>
            </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {products.map((product) => (
                    <tr key={product.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${product.sold ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
